      ...
      {currentData ? (
        <div className="overflow-x-auto rounded-lg" style={{ border: '1px solid var(--gray-200)' }}>
          <table className="cb-table">
            <thead>
              <tr>
                <th className="w-20 relative" style={{ paddingLeft: '20px', textAlign: 'left' }}>
              ...
              {(isPreRound
                ...
                return (
                  <Fragment key={entry.entryId}>
                    ...
                    >
                      <td className="cb-data text-sm" style={{ color: i < 3 ? 'var(--gold-600)' : 'var(--gray-500)', fontWeight: i < 3 ? 700 : 400, paddingLeft: '20px', textAlign: 'left' }}>
                        {isPreRound
